            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="NewBook"><img src="bootstrap/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            <li><a href="NewBook">Home</a></li>
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        <a href="NewBook"><i class="fa fa-home"></i> Home</a>
                        <span>Shop</span>
                    </div>
                </div>
            </div>
                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a href="koreabookList.jsp" onclick="location.href='NewBook'" data-toggle="collapse" data-target="#collapseTwo">NEW!</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a href="" data-toggle="collapse" data-target="#collapseThree">국내독서</a>
                                        </div>
